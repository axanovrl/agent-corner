    ...
    return (
        <Container>
            <div className="d-flex mb-1">
                <span className="font-weight-bold ac-text-title">Privacy Policy for Agent Corner</span>
            </div>
            <p className="privacy-pol">
                At acorner.herokuapp.com, accessible from https://acorner.herokuapp.com, one of our main priorities
                is the privacy of our visitors. This Privacy Policy document contains types of information that is
                collected and recorded by acorner.herokuapp.com and how we use it.
                If you have additional questions or require more information about our Privacy Policy, do not
                hesitate to contact us through email at acmain@acorner.com
            </p>
            <div className="d-flex mb-1">
                <span className="font-weight-bold ac-text-title">Log Files</span>
            </div>
            <p className="privacy-pol">
                acorner.herokuapp.com follows a standard procedure of using log files. These files log visitors when they
            ...
            <p className="privacy-pol">
                ...
                acorner.herokuapp.com. Our Privacy Policy was created with the help of the Privacy Policy Generator.
                ...
                advertisements and links that appear on acorner.herokuapp.com, which are sent directly to users' browser.
                ...
                Note that acorner.herokuapp.com has no access to or control over these cookies that are used by third-party advertisers.
            </p>
            <div className="d-flex mb-1">
                <span className="font-weight-bold ac-text-title">Third Party Privacy Policies</span>
            </div>
            <p className="privacy-pol">
                acorner.herokuapp.com's Privacy Policy does not apply to other advertisers or websites. Thus, we are
            ...
            <div className="d-flex mb-1">
                <span className="font-weight-bold ac-text-title">Online Privacy Policy Only</span>
            </div>
            <p className="privacy-pol">
                This Privacy Policy applies only to our online activities and is valid for visitors to our
                website with regards to the information that they shared and/or collect in acorner.herokuapp.com.
